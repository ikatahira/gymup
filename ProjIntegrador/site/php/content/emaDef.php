...
<head>
    ...
    <title>GymUp | Emagrecimento e definição</title>
...
<body>
    ...
    <div>
        <main class="container">
            ...
            <section class="hero" id="topo">
                <div>
                    <h1>O plano perfeito para perder gordura e definir o corpo</h1>
                    <p>Um método estruturado para acelerar o metabolismo, reduzir gordura corporal e conquistar definição muscular. Treinos dinâmicos, nutrição inteligente e foco na consistência.
                    </p>
                    <div class="badges">
            ...
            <section id="comecar">
                ...
                <div class="grid grid-2">
                    <div class="card">
                        <h3>Objetivo:</h3>
                        <ul class="list">
                            <li> - Reduzir gordura corporal, melhorar a composição corporal e manter massa magra.</li>
                        </ul>
                    </div>
                    <div class="card">
                        <h3>Frequência:</h3>
                        <ul class="list">
                            <li>- 3 a 6 vezes por semana</li>
                        </ul>
                    </div>
                </div>
            </section>
            ...
            <section>
                ...
                <div class="grid grid-2">
                    <div class="card">
                        <h3>Aquecimento</h3>
                        <ul class="list">
                            <li> 5 a 10 minutos de cardio leve</li>
                            <li> Movimentos articulares dinâmicos</li>
                            <li> Ativação muscular rápida</li>
                        </ul>
                    </div>
                    <div class="card">
                        <h3>Depois do treino</h3>
                        <ul class="list">
                            <li> Alongamento leve de 5 minutos</li>
                            <li> Respiração e relaxamento</li>
            ...
            <section id="nutricao">
                ...
                <div class="grid grid-3">
                    <div class="card">
                        <ul class="list">
                            <li> Déficit calórico moderado, priorizando proteínas para preservar massa muscular.</li>
                            <li> Carboidratos complexos antes do treino, proteína após o treino.</li>
                            <li> Evitar açúcares simples e ultraprocessados.</li>
                        </ul>
    ...
    <script src="../../js/content/emaDef.js"></script>
</body>
