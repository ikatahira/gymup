...
<body>
    ...
    <div>
        <main class="container">
            ...
            <section class="hero" id="topo">
                <div>
                    <h1>O plano perfeito para quem está começando</h1>
                    <p>Descubra um programa completo pensado para quem quer iniciar com segurança e eficiência. Combine treinos simples, progressivos e eficazes que ensinam o corpo e a mente a evoluir passo a passo.
                    </p>
                    <div class="badges">
                        <span class="badge">Sem complicação • aprenda o básico do jeito certo</span>
                        <span class="badge">2 dias/semana • 30–45min</span>
            ...
            <section id="comecar">
                ...
                <div class="grid grid-2">
                    <div class="card">
                        <h3>Objetivo:</h3>
                        <ul class="list">
                            <li> - Aprender a execução correta dos exercícios</li>
                        </ul>
                    </div>
                    <div class="card">
                        <h3>Frequência:</h3>
                        <ul class="list">
                            <li>- 2 a 3 vezes por semana</li>
                        </ul>
                    </div>
                </div>
            </section>
            ...
            <section>
                ...
                <div class="grid grid-2">
                    <div class="card">
                        <h3>Aquecimento cardiovascular leve</h3>
                        <ul class="list">
                            <li> Caminhada rápida na esteira ou no local</li>
                            <li> Corrida leve</li>
                            <li> Pular corda devagar</li>
                        </ul>
                    </div>
                    <div class="card">
    ...
    <script src="../../js/content/iniciante.js"></script>
</body>
