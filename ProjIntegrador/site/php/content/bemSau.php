...
<head>
    ...
    <title>GymUp | Bem estar e saúde</title>
...
<body>
    ...
    <div>
        <main class="container">
            ...
            <section class="hero" id="topo">
                <div>
                    <h1>O plano perfeito para cuidar do corpo e da mente</h1>
                    <p>Um programa voltado à saúde integral, com exercícios equilibrados, alongamentos e práticas que melhoram disposição, sono e qualidade de vida.
                    </p>
                    <div class="badges">
    ...
    <script src="../../js/content/bemSau.js"></script>
</body>
