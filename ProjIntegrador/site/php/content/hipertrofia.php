...
<body data-barba="wrapper">
    ...
    <div>
        <main class="container">
            ...
            <section class="hero" id="topo">
                <div>
                    <h1>O plano perfeito para hipertrofia</h1>
                    <p>Descubra um plano completo de hipertrofia que combina treinos inteligentes, alimentação
                        estratégica e
                        recuperação adequada. Ideal para quem quer transformar o corpo com resultados reais e
                        consistentes.
                    </p>
                    <div class="badges">
            ...
            <!-- PLANO DE TREINO -->
            <section id="treino">
                <h2>Plano de treino (6 dias/semana)</h2>
                <p class="lead" style="border-bottom: 2px solid var(--cta-clr); width: 317px;">Lembre-se de usar cargas
                    leves no inicio.</p>
                <div class="card">
                    <div style="display: flex; justify-content: space-between;">
                        <label for="filtroDia" style="margin-right:10px; font-weight:bold;">
                            Filtrar por dia:
                        </label>
                        <button class="edit">
                    ...
                    <table aria-label="Plano de treino para iniciantes">
                        <thead>
                            <tr>
                                <th>Dia</th>
                                <th>Exercício</th>
                        ...
                        <tbody class="lista">
                            <!-- <tr data-glightbox="title: Agachamento livre ou no Smith; description: 🦵 Pise inteiro no chão, mantenha coluna neutra, desça até confortável."
                                data-href="https://cdn.exercisedb.com/images/agachamento.gif">
                                <td>Seg</td>
                                <td>Agachamento livre ou no Smith</td>
                                <td>3 × 8–10</td>
                                <td>60–90s</td>
                                <td>Coluna neutra; profundidade confortável</td>
                            </tr>
                            <tr>
                                <td>Seg</td>
                                <td>Supino reto (halteres ou barra)</td>
                                <td>3 × 8–10</td>
                                <td>60–90s</td>
                                <td>Ombros para baixo, pés firmes</td>
                            </tr>
                            <tr>
                                <td>Seg</td>
                                <td>Remada baixa na máquina</td>
                                <td>3 × 10–12</td>
                                <td>60–90s</td>
                                <td>Puxe com as costas, não só os braços</td>
                            </tr>
                            <tr>
                                <td>Qua</td>
                                <td>Levantamento terra romeno (halteres)</td>
                                <td>3 × 8–10</td>
                                <td>75–90s</td>
                                <td>Dobre o quadril; coluna neutra</td>
                            </tr>
                            <tr>
                                <td>Qua</td>
                                <td>Desenvolvimento de ombros (halteres)</td>
                                <td>3 × 10–12</td>
                                <td>60–90s</td>
                                <td>Não hiperestenda a lombar</td>
                            </tr>
                            <tr>
                                <td>Qua</td>
                                <td>Puxada na frente (pegada aberta)</td>
                                <td>3 × 10–12</td>
                                <td>60–90s</td>
                                <td>Peito aberto, desça controlando</td>
                            </tr>
                            <tr>
                                <td>Sex</td>
                                <td>Avanço / passada (halteres)</td>
                                <td>2–3 × 10 por perna</td>
                                <td>60–90s</td>
                                <td>Passo longo; joelho alinhado</td>
                            </tr>
                            <tr>
                                <td>Sex</td>
                                <td>Tríceps na polia (corda)</td>
                                <td>2–3 × 12–15</td>
                                <td>45–60s</td>
                                <td>Cotovelos fixos ao corpo</td>
                            </tr>
                            <tr>
                                <td>Sex</td>
                                <td>Rosca direta (halteres)</td>
                                <td>2–3 × 12–15</td>
                                <td>45–60s</td>
                                <td>Sem balançar o tronco</td>
                            </tr>
                            <tr>
                                <td>+</td>
                                <td>Prancha</td>
                                <td>2 × 20–40s</td>
                                <td>45–60s</td>
                                <td>Umbigo para dentro, glúteos contraídos</td>
                            </tr> -->
                        </tbody>
                    </table>
                    <div class="grupo-muscular-controles">
                        <button id="prevGrupo">&lt;</button>
                        <span id="grupoAtual">A</span>
                        <button id="nextGrupo">&gt;</button>
                    </div>
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <p class="note" style="margin-top:20px">
                            Abdômen em 2 dias da semana
                        </p>
                        <i class="fa-solid fa-question btnAbrir"></i>
                    </div>
                </div>
            </section>
            ...
            <section>
                ...
                <div class="grid grid-2">
                    <div class="card">
                        <h3>Aquecimento dinâmico</h3>
                        <ul class="list">
                            <li> 5 min cardio leve (esteira/bike).</li>
                            <li> Mobilidade de quadril, ombro e tornozelo (10–12 rep).</li>
                            <li> 1 série de 12 repetições com <span class="tag">50% da carga</span> do primeiro
                                exercício.</li>
                        </ul>
                    </div>
                    <div class="card">
                        ...
                        <ul class="list">
                            <li> 2–3 min de respiração calma antes de ir embora.</li>
                            <li> 5–10 min de volta à calma (caminhada leve).</li>
                            <li> Alongamentos leves para áreas tensas (30–40s cada).</li>
                        </ul>
                    </div>
                </div>
            </section>
            ...
            <section id="nutricao">
                ...
                <div class="grid grid-3">
                    <div class="card">
                        <h3>Prato do iniciante</h3>
                        <ul class="list">
                            <li> Proteína: ovos, frango, peixe, carne magra, tofu.</li>
                            <li> Carboidratos: arroz, batata, mandioca, aveia, frutas.</li>
                            <li> Gorduras boas: azeite, abacate, castanhas.</li>
                        </ul>
            ...
            <div class="modal-content">
                ...
                <div class="rightPart">
                    ...
                    <div class="input-pr" style="display: flex; flex-direction: column;">
                        ...
                        <input type="number" id="prInput" min="0" placeholder="Ex: 80" style="margin-top: 10px; padding: 10px; width: 130px;">
    ...
    <script src="../../js/content/hipertrofia.js"></script>
</body>
